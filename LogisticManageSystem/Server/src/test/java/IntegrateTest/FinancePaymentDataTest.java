...
public class FinancePaymentDataTest {
	...
	public PaymentPO paymentPo1 = new PaymentPO("8736473827",PaymentType.SALARY,cal1,accountPo1.getName(),23452.2);
	public PaymentPO paymentPo2 = new PaymentPO("8394837820",PaymentType.FREIGHT,cal2,accountPo2.getName(),83732.2);
